...
public class Hospital {
	...
	public String insertHospital(String name, String address, String regId, String teleNo) {
		String output = "";
		try {
			...
			String query = " insert into hospitals (`hospitalID`,`name`,`address`,`regId`,`teleNo`)" 
			+ " values (?, ?, ?, ?, ?)";
			...
			preparedStmt.setString(4, regId);
			preparedStmt.setString(5, teleNo);
	...
	public String readHospitals() {
		...
		try {
			...
			output = "<table border='1'><tr><th>Hospital Name</th> <th>Address</th><th>Registration ID</th>"
					+ "<th>Telephone Number</th> <th>Update</th><th>Remove</th></tr>";
	...
	public String updateHospital(String ID, String name, String address, String regId, String teleNo) {
		String output = "";
		try {
			Connection con = connect();
			if (con == null) {
			...
			// create a prepared statement
			String query = "UPDATE hospitals SET name=?,address=?,regId=?,teleNo=? WHERE hospitalID=?";
			PreparedStatement preparedStmt = con.prepareStatement(query);
			// binding values
			preparedStmt.setString(1, name);
			preparedStmt.setString(2, address);
			preparedStmt.setString(3, regId);
			preparedStmt.setString(4, teleNo);
